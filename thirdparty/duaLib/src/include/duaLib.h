...
typedef enum ScePadTriggerEffectMode {
	...
	// DSX
	SCE_PAD_TRIGGER_EFFECT_MODE_RIGID,
	SCE_PAD_TRIGGER_EFFECT_MODE_PULSE,
	SCE_PAD_TRIGGER_EFFECT_MODE_RIGID_A,
	SCE_PAD_TRIGGER_EFFECT_MODE_RIGID_B,
	SCE_PAD_TRIGGER_EFFECT_MODE_RIGID_AB,
	SCE_PAD_TRIGGER_EFFECT_MODE_PULSE_A,
	SCE_PAD_TRIGGER_EFFECT_MODE_PULSE_B,
	SCE_PAD_TRIGGER_EFFECT_MODE_PULSE_AB,
	SCE_PAD_TRIGGER_EFFECT_MODE_PULSE_CALIBRATION,
